      ...
      <div className="relative w-full max-w-md">
        <div className="bg-white/95 backdrop-blur-md p-8 md:p-10 shadow-2xl rounded-3xl border border-white/20">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-800 mb-2">Sovereign Woodcraft</h1>
            <p className="text-gray-600">Welcome back to your craft journey</p>
          </div>
          ...
          <form onSubmit={submitHandler} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input type={showPassword ? "text" : "password"} id="password" placeholder="Enter your password" value={password} onChange={(e) => setPassword(e.target.value)} className="w-full pl-12 pr-12 py-4 bg-gray-50/50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all duration-200 placeholder-gray-400 text-gray-700" />
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-600">
              New to Sovereign Woodcraft?{' '}
              <Link to="/register" className="font-semibold text-amber-600 hover:text-amber-700 transition-colors duration-200">
                Create New Account
              </Link>
            </p>
          </div>
